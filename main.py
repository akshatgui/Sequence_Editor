...
class AppDemo(QMainWindow):
    def __init__(self):
        ...
        save_file_action = self.create_action(
            self, "./icon/save.png", "Save File", "Save file", self.file_save
        )
        ...
        undo_action = self.create_action(
            self, "./icon/undo.png", "Undo", "Undo", self.editor.undo
        )
        undo_action.setShortcut(QKeySequence.Undo)

        redo_action = self.create_action(
            self, "./icon/redo.png", "Redo", "Redo", self.editor.redo
        )
        ...
        wrap_text_action = self.create_action(
            self, "./icon/wrap.png", "Wrap Text", "Wrap text", self.toggle_wrap_text
        )
        ...
        icon_action = self.create_action(
            self, "./icon/itaxo.jpeg", "About", "About", self.openAbout
        )
    ...
    def file_saveAs(self):
        path, _ = QFileDialog.getSaveFileName(
            self, "Save file as", "", self.filterTypes
        )
    ...
    def create_action(
        self, parent, icon_path, action_name, set_status_tip, triggered_method
    ):
