...
class FasHighlighter(QSyntaxHighlighter):
    """Syntax highlighter for FAS files."""
...
class FastqHighlighter(QSyntaxHighlighter):
    """Syntax highlighter for the FASTQ files."""
